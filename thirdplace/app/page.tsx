...
const T: Record<string, Record<Lang, string>> = {
  searchFrom: {
    en: "From — your location or any address",
    fr: "Depuis — votre position ou une adresse",
  },
  searchTo: {
    en: "To — search any address or tap the map",
    fr: "Vers — chercher une adresse ou taper la carte",
  },
...
export default function App() {
  ...
  const toggleVoice = async () => {
    ...
    voiceRef.current = va;
    await va.connect().then(() => setVoiceActive(true));
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <button onClick={() => setShowSettings(true)} style={glassCardIcon}>
            ⚙️
          </button>
          {user ? (
            <div style={glassCardUser}>{user.username}</div>
          ) : (
            <button onClick={() => setAuthPanel("login")} style={glassCardUser}>
              {t("login", lang)}
            </button>
          )}
        </div>
              ...
              {"geolocation" in navigator && (
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11, color: "#6E6E68", marginTop: 1 }}
                    >
                      You
                    </div>
                  </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "6px 12px",
                borderRadius: 20,
                border: `1.5px solid ${voiceActive ? "#FC4C02" : "#E7E3DD"}`,
                background: voiceActive ? "#FFF1EB" : "transparent",
                color: voiceActive ? "#FC4C02" : "#6E6E68",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
                fontFamily: "inherit",
...
const dropdownItemStyle: React.CSSProperties = {
  ...
  padding: "10px 14px",
  cursor: "pointer",
  borderBottom: "0.5px solid #E7E3DD",
